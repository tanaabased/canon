...
- `[manual]` Keep each entry to a short bullet: **linked tool and supported baseline — when to prefer it; material exceptions.** Link authoritative upstream documentation for the supported version or release line. Include runtime, behavioral, or platform limits when they affect selection.
