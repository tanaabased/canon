...
- Removed obsolete Leia shell-syntax workarounds after adopting `@lando/leia@1.0.0-beta.9` and added executable coverage for template-sensitive syntax. [#42](https://github.com/tanaabased/canon/issues/42)
