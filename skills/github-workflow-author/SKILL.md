...
| [publish-codex-plugin](https://github.com/tanaabased/actions/blob/v1.0.1/publish-codex-plugin/README.md)   | Build a plugin archive and optionally upload it to a GitHub Release.      |
