...
2. Load the local action conventions plus only the shared README, stack, and JS canon needed for the touched surface.
3. Keep the action contract coherent across `action.yml`, runtime entrypoint, committed artifact, and README.
