...
- Link and apply Documentation Standards' documentation change gate before deciding whether prose needs to change, then describe how this skill documents the owned code surface when needed.
