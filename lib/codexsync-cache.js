 ...
 *
 * @param {object} context Sync roots and precomputed snapshots.
 * @param {string} context.sourceRoot Source tree to copy from.
 * @param {string} context.targetRoot Target tree to mutate.
 * @param {Map<string, object>} context.sourceEntries Desired source snapshot.
 * @param {Map<string, object>} context.targetEntries Existing target snapshot.
